...
extern krak_ws_connection stream;
extern krak_ws_connection orders;
extern krak_ws_connection websocket;

void* kraken_connect(void* args) {
	...
	// ***************************************
	// *** Connection to the orders stream ***
	// ***************************************
	...
	// *******************************************
	// *** Establish connection to the streams ***
	// *******************************************
